...
import { EscalierCalculateurClient } from '@/components/plugins/escaliers/EscalierCalculateurClient';

export const metadata = {
  title: "Calculateur d'escaliers — Plateforme constructeurs",
  description: "Calculez les dimensions de votre escalier et vérifiez la conformité aux normes du Code de construction du Québec (CCQ).",
};
...
export default function EscaliersPage() {
  return (
    <main className="min-h-screen px-4 py-8 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight mb-2">Calculateur d&apos;escaliers</h1>
