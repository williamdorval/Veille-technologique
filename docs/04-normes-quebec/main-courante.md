...
|---|---|---|
| Minimum | 800 mm | 31½ po |
| Maximum | 965 mm | 38 po |
| Maximum avec garde-corps requis | 1 070 mm | 42 po |

### Autres exigences

| Paramètre | Valeur | Commentaire |
|---|---|---|
| Distance minimale du mur | 50 mm | Pour pouvoir l'attraper |
| Diamètre si circulaire | 30–50 mm | Pour avoir une bonne prise |
| Espacement max des consoles | 1 200 mm | Fixation murale |
| Distance console du bout | 300 mm max | Première et dernière console |
| Profondeur vis dans le mur | 32 mm min | Solidité de la fixation |
...
| Escalier ≥ 1 100 mm de largeur | Oui, les deux côtés |
...
- **Escalier sur les deux côtés :** obligatoire si largeur ≥ 1 100 mm
...
> **Avertissement :** Les valeurs min/max (800–965 mm) sont cohérentes entre plusieurs sources professionnelles citant l'article 9.8.7.4 du CCQ. Elles doivent être vérifiées dans le texte officiel du CCQ (rbq.gouv.qc.ca).
...
```typescript
// Main courante
MAIN_COURANTE_HAUTEUR_MIN_MM: 800,   // Article 9.8.7.4 CCQ
MAIN_COURANTE_HAUTEUR_MAX_MM: 965,   // Article 9.8.7.4 CCQ
MAIN_COURANTE_HAUTEUR_MAX_AVEC_GARDE_CORPS_MM: 1070, // Article 9.8.7.4 §3 CCQ
MAIN_COURANTE_DISTANCE_MUR_MIN_MM: 50,   // Pour accessibilité
MAIN_COURANTE_OBLIGATOIRE_MIN_MARCHES: 3, // Résidentiel privé
MAIN_COURANTE_DOUBLE_MIN_LARGEUR_MM: 1100, // Les deux côtés si largeur ≥ 1100mm
```
