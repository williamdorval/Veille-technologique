...
- [x] T017 Créer le rapport final dans `docs/06-livrables/rapport-tranche-2-plugin-escaliers.md` : tâches implémentées (N sur 17), fonctionnalités P1/P2/P3 livrées, normes documentées avec sources, décisions techniques justifiées, limites connues, instructions pour tester manuellement — puis git push origin 002-plugin-escaliers
